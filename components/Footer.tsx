    ...
    <footer className="bg-gray-900 text-gray-300 py-12 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed opacity-80 max-w-xs">
              Advancing Technology for Humanity. The student branch of IEEE at
              Pulchowk Campus, dedicated to technical excellence and community
              growth.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start space-x-3">
                <MapPin size={18} className="text-ieee-blue mt-0.5" />
                <span>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
          <p>
            &copy; {new Date().getFullYear()} IEEE Pulchowk Student Branch. All
            rights reserved.
          </p>
