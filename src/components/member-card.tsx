  ...
  return (
    <div className="group relative bg-white rounded-xl p-6 border border-gray-100 shadow-sm hover:shadow-md hover:border-ieee-blue/30 transition-all duration-300 flex flex-col items-center text-center h-full">
      ...
      <div className="relative mb-4">
        <div className="w-24 h-24 rounded-full bg-gray-50 overflow-hidden border-2 border-transparent group-hover:border-ieee-blue/20 transition-all duration-300 flex items-center justify-center">
          {member.imageUrl ? (
            <img
              src={member.imageUrl}
              alt={member.name}
        ...
        <div className="absolute bottom-1 right-1 w-3 h-3 bg-ieee-blue rounded-full border-2 border-white opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
      </div>
